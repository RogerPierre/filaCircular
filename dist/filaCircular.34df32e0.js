...
var _ui = require("./ui");
let ui = new (0, _ui.Ui)();
let lista = new (0, _filaCircular.FilaCircular)(6);
ui.startloop(lista);

},{"./filaCircular":"2WrMq","./ui":"5D9k3"}],"2WrMq":[function(require,module,exports,__globalThis) {
...
class FilaCircular {
    ...
    RetornarPrimeiroElemento() {
        if (this.verificarSeVazia()) return null;
        return this.fila[0];
    }
    ...
    // Retornar o elemento que está no início da fila .
    retornarElementoInicial() {
        if (this.verificarSeVazia()) return "Nao e possivel adicionar elementos porque esta lista est\xe1 vazia.";
        else return this.fila[this.tamanho - 1];
    }
    //     Adicionar um novo elemento ao final da fila.
    adicionarElemento(elemento) {
        if (this.verificarSeCheia()) return "Cheia.";
        else {
    ...
    removerElemento() {
        if (this.verificarSeVazia()) return "A fila est\xe1 vazia. N\xe3o h\xe1 elementos para remover.";
        else {
...
class Ui {
    ...
    startloop(lista) {
        while(true){
            let reposta = Number(prompt(`Lista: ${lista.exibirFila()} \n add(1)\nremove(2)\nfront(3)\nempty?(4)\nfull?(5)\nnumElements(6)\nelements(7)\ncapacite(8)\nFreeLoots(0)`));
            switch(reposta){
                case 0:
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["3dtlh","gH3Lb"], "gH3Lb", "parcelRequire7c76", {})

//# sourceMappingURL=filaCircular.34df32e0.js.map
